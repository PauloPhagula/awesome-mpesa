...
- https://www.vm.co.mz/m-pesa/artigo/api-aberta-do-m-pesa - M-Pesa Open API service description
...
- [mpesa-node-api](https://github.com/thatfiredev/mpesa-node-api) - Node.js library for M-Pesa API (mozambique Mozambique).
